        ...
        <section className="py-37.5">
            <div className="container">
                <div className="text-center flex items-center justify-center">
                    <div>
                        <h3 className=" font-bold text-2xl uppercase text-[#FE8935]">
                            Best Product
                        </h3>
                ...
                <div className="flex gap-[120px] items-center mt-[107px]">
                    ...
                    <div>
                        <h2 className="font-bold text-4xl">
                            Beneful Dog Food Pet food Nestlé Purina
                        </h2>
                        <p className="text-[#FE8935] text-2xl mt-[15px]">
                            $56.20
                        </p>
                        <p className="font-normal text-[20px] w-[720px] mt-[25px] text-[#707070] text-justify">
