...
const ProductCard = ({
  ...
  return (
    <div className="bg-white px-[11px] pt-[11px] pb-[29px] rounded-[9px]">
      <div
        className={`w-full bg-linear-to-tl from-[#fe89355b] via-[#fec53569] to-[#D9D9D9] grid place-items-center rounded-[9px] relative ${sale ? "h-[556px]" : "h-[309px]"}`}
      >
        {sale && (
        ...
        <Image
          ...
          src={img}
          alt="image"
          className={`w-full object-cover ${sale ? "h-[556px]" : "h-full"}`}
          width={300}
          height={300}
        />
      </div>
